...
import { solarFAQs } from '../../data/solar'
import { Accordion } from '../construction/Accordion'

export const SolarFAQ: React.FC = () => {
    ...
    <section className="w-full bg-white py-12 lg:py-16 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center justify-between">
          ...
          >
            <div className="w-full aspect-square md:aspect-auto md:h-[550px] bg-[#fafafa] rounded-3xl overflow-hidden flex items-center justify-center p-2 md:p-4">
              <img
                src="/assets/Faq/solar/faq-solar.png"
